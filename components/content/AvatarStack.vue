...
<template>
  <div class="group flex items-center mb-6 w-26 h-20 relative cursor-pointer" @click="handleClick">
    <div class="size-20 left-1 rounded-full absolute shadow-md z-20">
      <NuxtImg :src="avatars[0]" alt="Avatar" class="w-full h-full rounded-full" height="128" width="128" />
    </div>
    <div :class="[
      ...
      <NuxtImg :src="avatars[1]" alt="Avatar" class="w-full h-full rounded-full" height="128" width="128" />
    </div>
    <div :class="[
      ...
      <NuxtImg :src="avatars[2]" alt="Avatar" class="w-full h-full rounded-full" height="128" width="128" />
    </div>
  </div>
</template>
