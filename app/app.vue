import { UFooter, UButton } from '../.nuxt/content/components';
<template>
  <div class="pt-8">
    <UApp>
      <NuxtPage />
      <UFooter>
        ...
        <template #right>
          ...
          <UTooltip text="GPG">
            <UButton icon="ph:key-bold" color="neutral" variant="subtle" to="https://keys.openpgp.org/vks/v1/by-fingerprint/60FE4D8C912EFDC5E37AD02EE56015D56B08FDBC"
