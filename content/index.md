...
cards:
  - title: mnl-website
    description: Public and internal website for the Mouvement National Lycéen
  ...
  - title: gazette
    description: A mobile PWA NuxtJS client for reverse-engineered Europresse API.
  ...
  - title: iconschanger.koplugin
    description: KOReader plugin for downloading and applying custom icon packs from the Iconify API
